...
export default function Konfigurator() {
  ...
  const initialPackage = packages.some(pkg => pkg.id === packageFromQuery)
    ? packageFromQuery!
    : packages[1].id
      ...
      <section className="relative isolate overflow-hidden bg-[#102018] px-5 py-14 text-white sm:px-6 lg:py-20">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_0.65fr] lg:items-end">
            <div>
              <h1 className="max-w-3xl text-5xl font-black tracking-tight md:text-6xl">Konfigurator zestawu</h1>
