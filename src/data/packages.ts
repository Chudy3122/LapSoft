...
export const packages: Package[] = [
  {
    ...
    includes: ['Laptop Dell Vostro 15', 'Torba na laptopa', 'Zasilacz', 'Konfiguracja i uruchomienie'],
  ...
  },
  {
    ...
    includes: ['Laptop Dell Vostro 15', 'Monitor Xiaomi A27i 27"', 'Kabel HDMI', 'Torba na laptopa', 'Zasilacz', 'Konfiguracja i uruchomienie'],
